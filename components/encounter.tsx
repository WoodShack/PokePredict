...
export default function Encounter() {
  ...
  // add sound effects
  const correctSound =
    typeof window !== "undefined" ? new Audio("/public/correct.mp3") : null;

  const wrongSound =
    typeof window !== "undefined" ? new Audio("/public/wrong.mp3") : null;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-100 to-yellow-200 p-6">
      ...
      <div
        id="encounter-question"
        className="border border-gray-300 rounded-lg p-4 shadow-md bg-white mt-6 mx-auto max-w-md w-full"
      >
